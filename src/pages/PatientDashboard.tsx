        ...
        <div className="px-5 pt-5 pb-5 animate-fade-in space-y-6">
          ...
          <div className="grid grid-cols-3 gap-3 scroll-fade-in">
            {summaryCards.map((s, idx) => (
              <div key={s.label} className="scroll-scale-in bg-card/80 backdrop-blur-md rounded-2xl border border-white/20 p-3 text-center transition-all duration-500 ease-out hover:-translate-y-1 hover:scale-[1.02] hover:bg-card hover:shadow-elevated hover:border-primary/50 press-zoom" style={{ animationDelay: `${idx * 100}ms` }}>
          ...
          {/* Action Buttons with glassmorphism and animations */}
          <div className="grid gap-4 sm:grid-cols-2">
            <button type="button" onClick={() => handlePanelToggle("add-data")}
              className="scroll-fade-in rounded-3xl border border-white/20 bg-gradient-to-br from-card/60 to-card/30 backdrop-blur-md p-4 text-left transition-all duration-500 ease-out hover:-translate-y-1 hover:scale-[1.02] hover:shadow-elevated hover:border-primary/50 hover:from-card/80 hover:to-card/50 press-zoom">
            ...
            <button type="button" onClick={() => handlePanelToggle("insights")}
              className="scroll-fade-in rounded-3xl border border-white/20 bg-gradient-to-br from-card/60 to-card/30 backdrop-blur-md p-4 text-left transition-all duration-500 ease-out hover:-translate-y-1 hover:scale-[1.02] hover:shadow-elevated hover:border-primary/50 hover:from-card/80 hover:to-card/50 press-zoom" style={{ animationDelay: "100ms" }}>
            ...
            <button type="button" onClick={() => handlePanelToggle("calculators")}
              className="scroll-fade-in rounded-3xl border border-white/20 bg-gradient-to-br from-card/60 to-card/30 backdrop-blur-md p-4 text-left transition-all duration-500 ease-out hover:-translate-y-1 hover:scale-[1.02] hover:shadow-elevated hover:border-primary/50 hover:from-card/80 hover:to-card/50 press-zoom" style={{ animationDelay: "200ms" }}>
